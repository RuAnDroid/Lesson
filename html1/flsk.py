...
DEBUG = True
SECRET_KEY = '692e207b33b1b1b9166a4c444ccdaf83efe221c8'

app = Flask(__name__)

# app.config['SECRET_KEY'] = 'werwerwerwerwer342345425vbnvbcvbxhkkhkiopiop7867'
...
def index():
    ...
    dbase = FDateBase(db)
    # print(url_for('index'))
    return render_template("head.html", title="Главная", menu=dbase.get_menu())
...
def trade():
    db = get_db()
    dbase = FDateBase(db)
    return render_template("trade.html", title="Торговля", menu=dbase.get_menu())
